...
public static class GUILayoutEx {
    ...
    public static void ExpandableGUI(Action en, string title, ref bool enabled, ref bool expanded) => ExpandableGUI(en, null, null, null, null, null, title, null, false, ref enabled, ref expanded);
    ...
    public static Color ColorRgbSliders(Color color) {
        ...
        return oldR != newR || oldG != newG || oldB != newB ? new Color(newR / 255, newG / 255, newB / 255) : color;
    }
    ...
    public static Color ColorRgbaSliders(Color color) {
        ...
        return oldR != newR || oldG != newG || oldB != newB || oldA != newA
            ? new Color(newR / 255, newG / 255, newB / 255, newA / 255)
            : color;
    }
    ...
    public static bool ToggleList<T>(List<T> list, ref int selectedIndex, Func<T, string> nameFunc) {
        ...
        if(moveUp != -1) {
            changed = true;
            (list[moveUp - 1], list[moveUp]) = (list[moveUp], list[moveUp - 1]);
            ...
            changed = true;
            (list[moveDown + 1], list[moveDown]) = (list[moveDown], list[moveDown + 1]);
