    ...
    public class MultipleKeyConfigDrawer : ModelDrawable<KeyConfig> {
        ...
        public MultipleKeyConfigDrawer(KeyManager manager, List<string> targets, KeyConfig criterion)
            : base(criterion ?? new KeyConfig(),
                  string.Format(Main.Lang.Get("KEYCONFIG_KEY_CONFIGURATION", "Key {0} Configuration"),
            ...
            relativeKeyNames = this.targets
                ...
                .Select(k => KeyViewerUtils.KeyName(k))
                .ToList();
        }
        ...
        public override void Draw() {
            ...
            if(Drawer.DrawString(FormatText(Main.Lang.Get("KEYCONFIG_TEXT_FONT", "Text Font"), "Font"), ref tempFont)) {
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Label($"<b>{Main.Lang.Get("KEYCONFIG_TEXT", "Text")}</b>");
            GUILayout.FlexibleSpace();
            GUILayout.EndHorizontal();
            ...
            if(model.EnableCountText) {
                GUILayout.BeginHorizontal();
                GUILayout.Label($"<b>{Main.Lang.Get("KEYCONFIG_COUNT_TEXT", "Count Text")}</b>");
                GUILayout.FlexibleSpace();
                GUILayout.EndHorizontal();
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Label($"<b>{Main.Lang.Get("KEYCONFIG_BACKGROUND_IMAGE", "Background Image")}</b>");
            GUILayout.FlexibleSpace();
            GUILayout.EndHorizontal();
            ...
            if(model.EnableOutlineImage) {
                GUILayout.BeginHorizontal();
                GUILayout.Label($"<b>{Main.Lang.Get("KEYCONFIG_OUTLINE_IMAGE", "Outline Image")}</b>");
                GUILayout.FlexibleSpace();
                GUILayout.EndHorizontal();
        ...
        void SetVectorConfig(string fieldName) {
            ...
            bool IsRelative(object instance, object o, System.Type t) =>
