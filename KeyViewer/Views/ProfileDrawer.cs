...
public class ProfileDrawer : ModelDrawable<Profile> {
    ...
    public ProfileDrawer(KeyManager manager, Profile profile, string name) : base(profile, string.Format(Main.Lang.Get("PROFILE_CONFIGURATE_PROFILE", "Configurate {0} Profile"), name)) => this.manager = manager;
